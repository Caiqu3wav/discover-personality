...
import MbtiScores from "../components/testsmbti/mbtiScores";
import resultadosFunc from "../components/testsmbti/resultadosFunc";
...
export default function Result({ result }) {
  ...
  creditWords.set(3.5, "CLARO");
  creditWords.set(3.0, "CLARO");
  creditWords.set(2.5, "CLARO");
  creditWords.set(2.0, "ALTA PROBABILIDADE");
  creditWords.set(1.5, "UMA BOA PROBABILIDADE");
  creditWords.set(1.0, "PROVAVELMENTE");
  creditWords.set(0.5, "BAIXA PROBABILIDADE");
    ...
    <main>
      ...
      <div className={"container mx-auto"}>
          ...
          <div className={"flex flex-col md:flex-row justify-around"}>
            ...
            >
              ...
              <div className={"mt-6 flex flex-col items-center"}>
                <p className={"font-medium text-md"}>Seu personagem:</p>
                ...
                <h4 className={"mt-6 text-lg font-medium"}>Ou</h4>
                <div className={"w-full flex justify-center"}>
                  <h2
                    className={
        ...
        <div className={"flex flex-col items-center mb-20"}>
          <h1 className={"text-4xl text-center mb-8"}>Resultados dos testes</h1>
          <div className={"flex flex-col items-center justify-center"}>
            <div className={""}>
              <resultadosFunc cogFunctions={cogFunctions} />
            </div>
                </div>
        </div>
        <div className={"border-b-2 w-3/4 mx-auto mb-12"}></div>
