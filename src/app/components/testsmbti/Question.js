...
export default function Question(props) {
    // console.log(props)
    const { index, cogFunctions, question } = props;
    let questionChecked = [];
    let questionChoosen = [];
    ...
    const onChangeHandler = (e) => {
        ...
        if (props.cogFunction1 && props.cogFunction2) props.onClickRadio(choice, index, props.cogFunction1, props.cogFunction2);
        else props.onClickRadio(choice, index, cogFunction);
        ...
        <div className={"question-card-container flex flex-col items-center"} >
            ...
            <div>
                <div onChange={onChangeHandler} className="question-radio flex flex-row justify-center items-center">
                    <h1 style={{color: "#8b4766"}} className={"hidden mr-4 font-normal sm:block"}>Não</h1>
                    ...
                    <h1 style={{color: "#649821"}} className={"hidden ml-4 font-normal sm:block"}>Sim</h1>
                </div>
                <div className="flex sm:hidden flex-row justify-between px-4">
                    <h1 style={{color: "#8b4766"}}>Não</h1>
                    <h1 style={{color: "#649821"}}>Sim</h1>
                </div>
            </div>
