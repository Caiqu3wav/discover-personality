...
import IsfjPic from "../../../../public/assets/mbti-char-imgs/isfj.png"
import Image from "next/image";
import "../mbtipages.css"
import MainDivContainer from "../../components/MainDiv/MainDivContainer";
import MainDiv from "../../components/MainDiv/MainDiv";

export default function IsfjPage() {

    return(
        <MainDivContainer>
      <MainDiv>

      <Image src={IsfjPic} className="a w-[160px] self-center mt-4" alt="" />
<h1 className="title-type text-3xl font-bold self-center text-blue-500">ISFJ</h1>
<p className="flex text-green-600 font-semibold gap-2 self-center">
  <span>SI</span> <span>FE</span> <span>TI</span> <span>NE</span>
</p>
<p className="flex flex-col gap-3">
  <span>
    ISFJ é um dos 16 tipos de personalidade identificados pelo Indicador de Tipo de Personalidade Myers-Briggs (MBTI).
    Se você se identifica como ISFJ, significa que seu tipo de personalidade é melhor descrito como Introvertido,
    Observador, Sentimental e Julgador. Às vezes, referidos como o "Defensor" ou o "Protetor", as pessoas com este
    tipo de personalidade geralmente são práticas, lógicas e confiáveis.
  </span>
<span className="text-green-800 font-semibold">Principais Características do ISFJ:</span>

<span className="text-slate-500">Confiável:</span>

  <span>
    Com sua natureza introvertida e observadora, ISFJs são confiáveis e dedicados. Eles cumprem suas responsabilidades
    com integridade.
  </span>
  <span className="text-slate-500">Organizado:</span>
  <span>
    ISFJs valorizam a ordem e a estrutura. Eles planejam com antecedência e preferem ambientes organizados.
  </span>
  <span className="text-slate-500">Analítico:</span>
  <span>
    ISFJs abordam situações de maneira lógica e analítica. Eles se concentram nos fatos e tomam decisões baseadas em
    evidências.
  </span>
  <span className="text-slate-500">Leal:</span>
  <span>
    ISFJs são leais aos seus compromissos e relacionamentos. Eles valorizam a confiança mútua e a responsabilidade.
  </span>
...
<span className="flex flex-col gap-2">
  ...
  <span>
    <span className="text-green-700">Funções Cognitivas do ISFJ:</span>
    <br />
...
<br /> <br />
  ...
  <span>
    <span className="font-semibold">Relações Pessoais com ISFJs:</span>
    <br />
    <span>
      ISFJs valorizam relações baseadas na confiança e no comprometimento. São reservados, mas leais e dedicados aos
      amigos e familiares. Podem ter dificuldade em expressar emoções abertamente.
    </span>
  </span>
  <span className="font-semibold">Compatibilidade ISFJ:</span>
  <br />
  <span>
  ...
  <span>Essa descrição destaca os traços essenciais do tipo de personalidade <span className="text-purple-600">ISFJ</span>,
